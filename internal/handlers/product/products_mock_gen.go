...
func (_m *ProductsMock) CreateProduct(ctx context.Context, _a1 models.Product) (int, error) {
...
func (_m *ProductsMock) UpdateProduct(ctx context.Context, _a1 models.Product) error {
	ret := _m.Called(ctx, _a1)
